      ...
      <div className="container mx-auto px-4 grid md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="/founders" className="text-muted-foreground hover:text-primary transition-colors">History</Link></li>
            <li><Link href="/administration" className="text-muted-foreground hover:text-primary transition-colors">Team</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="/projects" className="text-muted-foreground hover:text-primary transition-colors">Hackathons</Link></li>
            <li><Link href="/projects" className="text-muted-foreground hover:text-primary transition-colors">Workshops</Link></li>
